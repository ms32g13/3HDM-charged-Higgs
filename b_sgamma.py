...
def Plot_3():#Figure 3 DOI: 10.1142/S0217751X17501457
    ...
    y11_axis = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
                                      [1.0],[-1.0],[0],[0]) )
    y12_axis = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
                                      [1.0/2.0],[-1.0/4.0],[0],[0]) )
    y130_axis = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
                                      [1.0/30.0],[-1.0/900],[0],[0]) )
    y21_axis = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
                                      [1.0],[1.0],[0],[0]) )
    y22_axis = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
                                      [1.0/2.0],[1.0],[0],[0]) )
    y230_axis = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
                                      [1.0/30.0],[1.0],[0],[0]) )
...
def Plot_8_9():
   ...
   #mly = MultipleLocator(0.25)
    y48imx_axis = BR_B_Xs_gamma(4.8,mhch,mhch,mhch + mass_differ ,\
                        [1.0],XYimx_axis,[0.0],[0.0])
    y24imx_axis = BR_B_Xs_gamma(2.4,mhch,mhch,mhch + mass_differ,\
                        [1.0],XYimx_axis,[0.0],[0.0])
    y96imx_axis = BR_B_Xs_gamma(9.6,mhch,mhch,mhch + mass_differ,\
                        [1.0],XYimx_axis,[0.0],[0.0])
    y48phi_axis = BR_B_Xs_gamma(4.8,mhch,mhch,mhch + mass_differ ,\
                        [0.5],XYexpim_axis,[0.0],[0.0])
    y24phi_axis = BR_B_Xs_gamma(2.4,mhch,mhch,mhch + mass_differ,\
                        [0.5],XYexpim_axis,[0.0],[0.0])
    y96phi_axis = BR_B_Xs_gamma(9.6,mhch,mhch,mhch + mass_differ,\
                        [0.5],XYexpim_axis,[0.0],[0.0])
...
#            )
    ...
    y12_2hdm = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
                                      [1.0/2.0],[-1.0/4.0],[0],[0]) )
    y12_3hdm = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
...
#                                              [1.0/2.0],[1.0],[0],[0])\
#            )
    y22_2hdm = np.array(BR_B_Xs_gamma(mb,mw,x_axis,x_axis + mass_differ,\
                                      [1.0/2.0],[1.0],[0],[0]) )
